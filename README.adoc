...
image:https://github.com/BojanStipic/website/actions/workflows/node.js.yml/badge.svg[Node.js CI]
image:https://github.com/BojanStipic/website/actions/workflows/codeql-analysis.yml/badge.svg[CodeQL analysis]
