...
In this article we are going to discuss different fetching types,
...
Only if we try to access that field, JPA provider will go ahead and fetch it
...
To make our fetch eager, even though our entity declares lazy loading,
