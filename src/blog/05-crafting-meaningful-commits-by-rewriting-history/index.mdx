...
date: "2022-12-28"
image: "./cover.png"
imageAlt: "Git history"
author: "Bojan Stipic"
tags: ["Git"]
---

import { Alert, AlertIcon, Container, Divider } from "@chakra-ui/react";

import { CCBYSALicenseNotice, Card } from "../../components";
...
<Alert status="info">
  <AlertIcon />
  Git commits are immutable. When I say "modify", what actually happens is that Git
  replaces the commit at the tip of the current branch with a completely new commit.
</Alert>
