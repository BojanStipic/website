...
<aside class="p-8 rounded-lg bg-base shadow">
    ...
    - [Relationship mapping](/blog/0002-jpa-pitfalls-relationship-mapping/) (this article)
    - [Eager/Lazy fetching](/blog/0003-jpa-pitfalls-eager-lazy-fetching/)
    - [Generating IDs](/blog/0004-jpa-pitfalls-generating-ids/)
