...
description: "In this article we are going to discuss different JPA fetching types, their pros and cons, and see which one you should prefer."
pubDate: 2022-08-18
...
their pros and cons, and see which one you should prefer.

<aside class="p-8 my-8 rounded-xl bg-base shdow">
