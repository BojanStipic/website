...
description: "In this article we are going to discuss some common JPA relationship mapping pitfalls."
pubDate: 2022-08-17
...
<div class="mx-auto flex max-w-xs justify-center">
  ![One to Many](./one-to-many-diag.svg)
</div>
...
<div class="mx-auto flex max-w-xs justify-center">
  ![Many to Many](./many-to-many-diag.svg)
</div>
