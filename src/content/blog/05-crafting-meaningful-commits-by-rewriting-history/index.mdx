...
description: "Having a concise and clear commit history is very valuable. It allows future readers to see _when_ a particular code change was introduced, and to get an additional context as to _why_ that change was made. In this article, I will show you some tips and tricks that will help you craft a useful commit history."
pubDate: 2022-12-28
coverUrl: "./cover.png"
tags: ["Git"]
---

Having a concise and clear commit history is very valuable.
It allows future readers to see _when_ a particular code change was introduced,
and to get an additional context as to _why_ that change was made.
In this article, I will show you some tips and tricks that will help you
craft a useful commit history.
...
<div class="mx-auto flex max-w-xs justify-center">
  ![Initial Git history](./initial-git-history.svg)
</div>
...
<div class="mx-auto flex max-w-xs justify-center">
  ![CR fixes commit](./cr-fixes-commit.svg)
</div>
...
<div class="mx-auto flex max-w-xs justify-center">
  ![More CR fixes commit](./more-cr-fixes-commit.svg)
</div>
