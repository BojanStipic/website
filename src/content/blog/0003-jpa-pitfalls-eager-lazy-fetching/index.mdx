...
import erDiag from "./er-diag.svg?raw";
...
<aside class="p-8 rounded-lg bg-base shadow">
    ...
    - [Relationship mapping](/blog/0002-jpa-pitfalls-relationship-mapping/)
    - [Eager/Lazy fetching](/blog/0003-jpa-pitfalls-eager-lazy-fetching/) (this article)
