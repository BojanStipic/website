...
description: "In this article we are going to discuss different JPA strategies for generating IDs."
pubDate: 2022-08-24
coverUrl: "./jpa-logo.png"
tags: ["Java", "JPA"]
---

In this article we are going to discuss different JPA strategies
for generating IDs.

<aside class="p-8 my-8 rounded-xl bg-base shadow">
