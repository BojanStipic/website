...
slug: "introduction-to-webassembly-and-rust"
description: >-
  This article gives an overview of WebAssembly and Rust alongside practical
  step-by-step examples of how to use them in your next Web app. If you would
  like to speed up performance-critical parts of your app, port a legacy
  codebase to the Web, or completely write your frontend in a programming
  language other than JavaScript, then this blog post is for you!
pubDate: 2022-07-20
cover: "./wasm-ferris.png"
...
today it can be used pretty much anywhere.
...
Macros are out of scope of this article, but for now you just need to know that
...
4. Write a simple program:
   ...
   how Rust provides some nice abstractions that makes it possible to write
